...
def test_every_agent_offers_hooks_and_renders_its_own_shape(tmp_path: Path) -> None:
    ...
    adapters removed — all five agents now take one.

    The property worth pinning is what changed: one fragment reaches five
    harnesses through five destinations. Claude, Codex and Droid read the
    document; OpenCode and Pi get generated source, because neither has a hooks
    file.
    """
    expected = {
